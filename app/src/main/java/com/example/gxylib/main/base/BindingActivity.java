 ...
 */
public abstract class BindingActivity<VB extends ViewDataBinding> extends BaseBindingActivity<VB> {
...
//        }
    ...
    protected void setTitleContent(View view) {
        ...
        if (null != baseLeftLayout)
            if (isBack())
                baseLeftLayout.setOnClickListener(v -> BindingActivity.this.finish());
    }
