...
import com.srwing.gxylib.coreui.mvp.BaseModel;
import com.srwing.gxylib.coreui.mvp.BaseMvpActivity;
import com.srwing.gxylib.coreui.mvp.BasePresenter;
 ...
 */
public abstract class MvpActivity<VB extends ViewDataBinding, P extends BasePresenter, M extends BaseModel> extends BaseMvpActivity<VB, P, M> {
...
//        }
    ...
    protected void setTitleContent(View view) {
        ...
        if (null != baseLeftLayout)
            if (isBack())
                baseLeftLayout.setOnClickListener(v -> MvpActivity.this.finish());
    }
