package com.srwing.gxylib.coreui.view.badgevview;
...
/**
 * Description:
 *                  BadgeView(this).bindTarget(image)
...
public class BadgeView extends View implements Badge {
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? ConvertUtils.px2dp(mBadgeTextSize) : mBadgeTextSize;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? ConvertUtils.px2dp(mBadgePadding) : mBadgePadding;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? ConvertUtils.px2dp(mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? ConvertUtils.px2dp(mGravityOffsetY) : mGravityOffsetY;
    }
